...
- Rust: [RustAnalyzer](https://rust-analyzer.github.io/book/installation.html)
...
Add support for a new LSP server is really simple. Example from [BasedPyright](src/lsp_client/servers/based_pyright.py):
